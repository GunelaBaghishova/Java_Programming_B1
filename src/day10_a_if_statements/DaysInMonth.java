...
public class DaysInMonth {
    public static void main(String[] args) {
        ...
        boolean has28Days = monthNumber == 9;
...
//
//        System.out.println();
//        if (true)System.out.println("2nd single statement in without curly braces");//------> you can do without curly braces if you have ONLY one single statement!!!!!!
//
//
//
//
